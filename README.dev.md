...
# install qcm as an editable package
...
The second is to use `tox`, which can be installed separately (e.g. with `pip install tox`), i.e. not necessarily inside the virtual environment you use for installing `qcm`, but then builds the necessary virtual environments itself by simply running:
...
cd $(mktemp -d qcm.XXXXXX)
git clone git@github.com:SURFQuantum/qcm .
...
Visit
[https://test.pypi.org/project/qcm](https://test.pypi.org/project/qcm)
and verify that your package was uploaded successfully. Keep the terminal open, we'll need it later.

In a new terminal, without an activated virtual environment or an env directory:

```shell
cd $(mktemp -d qcm-test.XXXXXX)
...
--extra-index-url https://pypi.org/simple qcm
```
...
Don't forget to also make a [release on GitHub](https://github.com/SURFQuantum/qcm/releases/new).GitHub-Zenodo integration will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.